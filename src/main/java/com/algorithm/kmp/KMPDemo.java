...
/**
 * Demonstration class for KMP Algorithm
 * 
 * This class showcases the KMP algorithm with various test cases including:
 * - Short strings (15-20 characters)
 * - Medium strings (100+ characters) 
 * - Long strings (500+ characters)
 * - Edge cases and performance measurements
 * 
 * @author Denis
 * @version 1.0
 */
public class KMPDemo {
    ...
    /**
     * Demo 1: Short String Test (15-20 characters)
     * Purpose: Verify basic functionality with simple example
     */
    ...
    /**
     * Demo 2: Medium String Test (paragraph-length, ~200 characters)
     * Purpose: Test performance with realistic text
     */
    ...
    /**
     * Demo 3: Long String Test (500+ characters)
     * Purpose: Evaluate efficiency with large text
     */
    ...
    /**
     * Demo 4: Edge Cases
     * Purpose: Verify robustness with corner cases
     */
     ...
     * Purpose: Demonstrate O(n+m) complexity with increasing text sizes
     */
    ...
    private static void performanceTest(int textSize, String pattern) {
        // Create text of specified size with pattern occurrences
